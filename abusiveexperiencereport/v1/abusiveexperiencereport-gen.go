...
func (c *SitesGetCall) doRequest(alt string) (*http.Response, error) {
	...
	return gensupport.SendRequest(googleapi.MethodIDToContext(c.ctx_, "abusiveexperiencereport.sites.get"), c.s.client, req)
}
...
func (c *ViolatingSitesListCall) doRequest(alt string) (*http.Response, error) {
	...
	req, _ := http.NewRequest("GET", urls, body)
	req.Header = reqHeaders
	return gensupport.SendRequest(googleapi.MethodIDToContext(c.ctx_, "abusiveexperiencereport.violatingSites.list"), c.s.client, req)
}
