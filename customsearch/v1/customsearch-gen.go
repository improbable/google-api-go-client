...
func (c *CseListCall) doRequest(alt string) (*http.Response, error) {
	...
	return gensupport.SendRequest(googleapi.MethodIDToContext(c.ctx_, "search.cse.list"), c.s.client, req)
}
...
func (c *CseSiterestrictListCall) doRequest(alt string) (*http.Response, error) {
	...
	req, _ := http.NewRequest("GET", urls, body)
	req.Header = reqHeaders
	return gensupport.SendRequest(googleapi.MethodIDToContext(c.ctx_, "search.cse.siterestrict.list"), c.s.client, req)
}
