...
type DatabaseInstance struct {
	...
	// of the instance is unknown. *RUNNABLE*: The instance has been stopped
	// by owner. It is not currently running, but it's ready to be
	// restarted. *SUSPENDED*: The instance is not available, for example
	// due to problems with billing. for example due to problems with
	...
	// unknown.
	//   "RUNNABLE" - The instance has been stopped by owner. It is not
	// currently running, but it's ready to be restarted.
...
type DemoteMasterContext struct {
	...
	// on-premises primary instance and Cloud SQL instance during the
	// demotion operation but also exposes you to the risk of future
	// replication failures. Change the value only if you know the reason
	// for the GTID divergence and are confident that doing so will not
...
type ExportContext struct {
	...
	// If the file already exists, the requests // succeeds, but the
	// operation fails. If *fileType* is // *SQL* and the filename ends with
...
// SQL instance is located, either in a specific Compute Engine zone, or
...
type Settings struct {
	...
	// ActiveDirectoryConfig: Active Directory configuration, for now
	...
	// be either *ASYNCHRONOUS* or *SYNCHRONOUS*. (Deprecated_ This property
...
// SqlActiveDirectoryConfig: Active Directory configuration, for now
// relevant only for SQL Server
...
func (c *ProjectsInstancesRescheduleMaintenanceCall) doRequest(alt string) (*http.Response, error) {
	...
	return gensupport.SendRequest(googleapi.MethodIDToContext(c.ctx_, "sql.projects.instances.rescheduleMaintenance"), c.s.client, req)
}
...
func (c *ProjectsInstancesStartExternalSyncCall) doRequest(alt string) (*http.Response, error) {
	...
	return gensupport.SendRequest(googleapi.MethodIDToContext(c.ctx_, "sql.projects.instances.startExternalSync"), c.s.client, req)
}
...
func (c *ProjectsInstancesVerifyExternalSyncSettingsCall) doRequest(alt string) (*http.Response, error) {
	...
	return gensupport.SendRequest(googleapi.MethodIDToContext(c.ctx_, "sql.projects.instances.verifyExternalSyncSettings"), c.s.client, req)
}
