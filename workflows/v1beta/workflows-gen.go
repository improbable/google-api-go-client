...
type Workflow struct {
	...
	// of a workflow is created as a result of updating the following fields
	// of a workflow: - `source_code` - `service_account` The format is
	// "000001-a4d", where the first 6 characters define the zero-padded
	// revision ordinal number. They are followed by a hyphen and 3
	// hexadecimal random characters.
	RevisionId string `json:"revisionId,omitempty"`

	// ServiceAccount: Name of the service account associated with the
	// latest workflow version. This service account represents the identity
	// of the workflow and determines what permissions the workflow has.
	...
	// project's default service account. Modifying this field for an
...
func (c *ProjectsLocationsGetCall) doRequest(alt string) (*http.Response, error) {
	...
	return gensupport.SendRequest(googleapi.MethodIDToContext(c.ctx_, "workflows.projects.locations.get"), c.s.client, req)
}
...
func (c *ProjectsLocationsListCall) doRequest(alt string) (*http.Response, error) {
	...
	return gensupport.SendRequest(googleapi.MethodIDToContext(c.ctx_, "workflows.projects.locations.list"), c.s.client, req)
}
...
func (c *ProjectsLocationsOperationsDeleteCall) doRequest(alt string) (*http.Response, error) {
	...
	return gensupport.SendRequest(googleapi.MethodIDToContext(c.ctx_, "workflows.projects.locations.operations.delete"), c.s.client, req)
}
...
func (c *ProjectsLocationsOperationsGetCall) doRequest(alt string) (*http.Response, error) {
	...
	return gensupport.SendRequest(googleapi.MethodIDToContext(c.ctx_, "workflows.projects.locations.operations.get"), c.s.client, req)
}
...
func (c *ProjectsLocationsOperationsListCall) doRequest(alt string) (*http.Response, error) {
	...
	return gensupport.SendRequest(googleapi.MethodIDToContext(c.ctx_, "workflows.projects.locations.operations.list"), c.s.client, req)
}
...
func (c *ProjectsLocationsWorkflowsCreateCall) doRequest(alt string) (*http.Response, error) {
	...
	c.urlParams_.Set("alt", alt)
	c.urlParams_.Set("prettyPrint", "false")
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1beta/{+parent}/workflows")
	urls += "?" + c.urlParams_.Encode()
	...
	return gensupport.SendRequest(googleapi.MethodIDToContext(c.ctx_, "workflows.projects.locations.workflows.create"), c.s.client, req)
}
...
func (c *ProjectsLocationsWorkflowsDeleteCall) doRequest(alt string) (*http.Response, error) {
	...
	return gensupport.SendRequest(googleapi.MethodIDToContext(c.ctx_, "workflows.projects.locations.workflows.delete"), c.s.client, req)
}
...
func (c *ProjectsLocationsWorkflowsGetCall) doRequest(alt string) (*http.Response, error) {
	...
	return gensupport.SendRequest(googleapi.MethodIDToContext(c.ctx_, "workflows.projects.locations.workflows.get"), c.s.client, req)
}
...
func (c *ProjectsLocationsWorkflowsListCall) doRequest(alt string) (*http.Response, error) {
	...
	return gensupport.SendRequest(googleapi.MethodIDToContext(c.ctx_, "workflows.projects.locations.workflows.list"), c.s.client, req)
}
...
func (c *ProjectsLocationsWorkflowsPatchCall) doRequest(alt string) (*http.Response, error) {
	...
	return gensupport.SendRequest(googleapi.MethodIDToContext(c.ctx_, "workflows.projects.locations.workflows.patch"), c.s.client, req)
}
