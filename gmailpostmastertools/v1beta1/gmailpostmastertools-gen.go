...
func (c *DomainsGetCall) doRequest(alt string) (*http.Response, error) {
	...
	return gensupport.SendRequest(googleapi.MethodIDToContext(c.ctx_, "gmailpostmastertools.domains.get"), c.s.client, req)
}
...
func (c *DomainsListCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	return gensupport.SendRequest(googleapi.MethodIDToContext(c.ctx_, "gmailpostmastertools.domains.list"), c.s.client, req)
}
...
func (c *DomainsTrafficStatsGetCall) doRequest(alt string) (*http.Response, error) {
	...
	return gensupport.SendRequest(googleapi.MethodIDToContext(c.ctx_, "gmailpostmastertools.domains.trafficStats.get"), c.s.client, req)
}
...
func (c *DomainsTrafficStatsListCall) doRequest(alt string) (*http.Response, error) {
	...
	return gensupport.SendRequest(googleapi.MethodIDToContext(c.ctx_, "gmailpostmastertools.domains.trafficStats.list"), c.s.client, req)
}
