...
func (c *V3LogImpressionsCall) doRequest(alt string) (*http.Response, error) {
	...
	return gensupport.SendRequest(googleapi.MethodIDToContext(c.ctx_, "playablelocations.logImpressions"), c.s.client, req)
}
...
func (c *V3LogPlayerReportsCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	return gensupport.SendRequest(googleapi.MethodIDToContext(c.ctx_, "playablelocations.logPlayerReports"), c.s.client, req)
}
...
func (c *V3SamplePlayableLocationsCall) doRequest(alt string) (*http.Response, error) {
	...
	req.Header = reqHeaders
	return gensupport.SendRequest(googleapi.MethodIDToContext(c.ctx_, "playablelocations.samplePlayableLocations"), c.s.client, req)
}
