...
// GoogleCloudVideointelligenceV1p1beta1FaceDetectionConfig: Config for
// FACE_DETECTION.
...
func (s *GoogleCloudVideointelligenceV1p1beta1FaceDetectionConfig) MarshalJSON() ([]byte, error) {
	type NoMethod GoogleCloudVideointelligenceV1p1beta1FaceDetectionConfig
	raw := NoMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}
...
// GoogleCloudVideointelligenceV1p1beta1PersonDetectionConfig: Config
...
func (s *GoogleCloudVideointelligenceV1p1beta1PersonDetectionConfig) MarshalJSON() ([]byte, error) {
	type NoMethod GoogleCloudVideointelligenceV1p1beta1PersonDetectionConfig
	raw := NoMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}
