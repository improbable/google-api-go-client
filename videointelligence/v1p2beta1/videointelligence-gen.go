...
// GoogleCloudVideointelligenceV1p2beta1FaceDetectionConfig: Config for
// FACE_DETECTION.
...
func (s *GoogleCloudVideointelligenceV1p2beta1FaceDetectionConfig) MarshalJSON() ([]byte, error) {
	type NoMethod GoogleCloudVideointelligenceV1p2beta1FaceDetectionConfig
	raw := NoMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}
...
// GoogleCloudVideointelligenceV1p2beta1ObjectTrackingConfig: Config for
// OBJECT_TRACKING.
...
func (s *GoogleCloudVideointelligenceV1p2beta1ObjectTrackingConfig) MarshalJSON() ([]byte, error) {
	type NoMethod GoogleCloudVideointelligenceV1p2beta1ObjectTrackingConfig
	raw := NoMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}
...
// GoogleCloudVideointelligenceV1p2beta1PersonDetectionConfig: Config
...
func (s *GoogleCloudVideointelligenceV1p2beta1PersonDetectionConfig) MarshalJSON() ([]byte, error) {
	type NoMethod GoogleCloudVideointelligenceV1p2beta1PersonDetectionConfig
	raw := NoMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields, s.NullFields)
}
...
// to the speech recognizer to favor specific words and phrases in the
// results.
