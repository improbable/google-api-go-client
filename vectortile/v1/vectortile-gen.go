...
func (c *FeaturetilesGetCall) doRequest(alt string) (*http.Response, error) {
	...
	return gensupport.SendRequest(googleapi.MethodIDToContext(c.ctx_, "vectortile.featuretiles.get"), c.s.client, req)
}
...
func (c *TerraintilesGetCall) doRequest(alt string) (*http.Response, error) {
	...
	return gensupport.SendRequest(googleapi.MethodIDToContext(c.ctx_, "vectortile.terraintiles.get"), c.s.client, req)
}
