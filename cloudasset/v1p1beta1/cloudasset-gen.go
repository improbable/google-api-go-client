...
func (c *IamPoliciesSearchAllCall) doRequest(alt string) (*http.Response, error) {
	...
	return gensupport.SendRequest(googleapi.MethodIDToContext(c.ctx_, "cloudasset.iamPolicies.searchAll"), c.s.client, req)
}
...
func (c *ResourcesSearchAllCall) doRequest(alt string) (*http.Response, error) {
	...
	return gensupport.SendRequest(googleapi.MethodIDToContext(c.ctx_, "cloudasset.resources.searchAll"), c.s.client, req)
}
