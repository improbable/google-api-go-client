...
type Disk struct {
	...
	// deleted at the end of the pipeline run, regardless of what this field
	// is set to.
	...
	// hard disk. See https://cloud.google.com/compute/docs/disks/#pdspecs
	// for details.
	//   "PERSISTENT_SSD" - Specifies a Google Compute Engine persistent
	// solid-state disk. See
...
// disk, the local path cannot be a glob and must be a file.
...
type PipelineResources struct {
	...
	// specified type to attach. By specifying this parameter, you will
	// download and install the following third-party software onto your
	// managed Compute Engine instances: NVIDIA® Tesla® drivers and
	// NVIDIA® CUDA toolkit.
	...
	// type. By specifying this parameter, you will download and install the
	// following third-party software onto your managed Compute Engine
	// instances: NVIDIA® Tesla® drivers and NVIDIA® CUDA toolkit. Please
	// see https://cloud.google.com/compute/docs/gpus/ for a list of
